...
String sSpecialty = 'LTC';
String sStatus = ApplicantType;
String sHomeRegion = '1';
String sRcode = ApplicantReferral;
// String sRecruiter = sApplicantRecruiter; - not Needed
String sSecondaryCTMCert = sSecondaryCert;
// String sApplicantExperience = 'applicant'; - Already Hardcodec in String
