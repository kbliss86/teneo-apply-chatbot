//Create File Prep GREV Task - Per Diem - API
...
String sdetails = "A new applicant - ${sName} has completed the application process through chatbot and needs file prep.";
...
//ring shcpId = "157430"
//String stesthcpId = "999999"; //Non Existent HCP for error handling test//
String stesthcpId = "157430"; //Nancy Nurse for Testing Integration//
String stags = "Onboarding File Prep";
...
try {
	...
	//If API for GREV task fails, then it will send an email to document processors//
            ...
            String emailBody = "the following HCP has applied but a file prep task was not able to be created, please create one manually: HCP ID:";
